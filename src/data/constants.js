...
export const INITIAL_LISTINGS = [
  { id: 1, emoji: '🏎️', imgBg: 'linear-gradient(160deg,#1a0d0a,#2e1500)', name: 'Ferrari 458 Italia', spec: '2015 · 42,000 km · Rosso Corsa', price: '₹2.8 Cr', location: 'Mumbai', views: '1.2K', verified: true, hp: '570', kmph: '325', sprint: '3.4s', engine: '4.5L V8', features: ['Original Paint', 'Full Service History', 'Ceramic Coating', 'Pirelli P Zero'], seller: { id: 'seller-1', name: 'RohanM', sub: 'Verified Seller · 4 listings', bg: 'linear-gradient(135deg,#f0c040,#e8a020)', color: '#000' }, desc: 'One owner, always garaged, full Ferrari service history from authorized dealer.', category: 'Supercar' },
  { id: 2, emoji: '🚗', imgBg: 'linear-gradient(160deg,#0d1117,#141a24)', name: 'BMW M4 Competition', spec: '2021 · 18,000 km · Alpine White', price: '₹85 L', location: 'Delhi', views: '876', verified: true, hp: '510', kmph: '290', sprint: '3.9s', engine: '3.0L S58', features: ['M Carbon Seats', 'Harman Kardon', 'Adaptive M Suspension', 'Track Package'], seller: { id: 'seller-2', name: 'PriyaK', sub: 'Verified Seller · 2 listings', bg: 'linear-gradient(135deg,#3b82f6,#2563eb)', color: '#fff' }, desc: 'Pristine M4, carbon fibre roof, full M options package.', category: 'Sports' },
  { id: 3, emoji: '⚡', imgBg: 'linear-gradient(160deg,#040d12,#0d2030)', name: 'Porsche Taycan Turbo', spec: '2022 · 12,000 km · Gentian Blue', price: '₹1.2 Cr', location: 'Bangalore', views: '654', verified: true, hp: '680', kmph: '260', sprint: '3.2s', engine: 'Dual Motor Electric', features: ['Performance Battery Plus', 'Sport Chrono', 'Air Suspension', 'Panoramic Roof'], seller: { id: 'seller-3', name: 'SureshV', sub: 'Verified Seller · 1 listing', bg: 'linear-gradient(135deg,#22c55e,#16a34a)', color: '#fff' }, desc: 'Loaded Taycan Turbo, fully electric with 500km+ range.', category: 'Electric' },
  { id: 4, emoji: '🚙', imgBg: 'linear-gradient(160deg,#17100d,#241a14)', name: 'Nissan GT-R R35', spec: '2017 · 35,000 km · Pearl White', price: '₹1.05 Cr', location: 'Pune', views: '2.1K', verified: false, hp: '565', kmph: '315', sprint: '2.9s', engine: '3.8L Twin-Turbo V6', features: ['Launch Control', 'Bose Audio', 'Nismo Upgrades', 'Carbon Brakes'], seller: { id: 'seller-4', name: 'AmitJ', sub: 'Private Seller · 1 listing', bg: 'linear-gradient(135deg,#8b5cf6,#7c3aed)', color: '#fff' }, desc: 'Godzilla in stunning Pearl White. Stage 1 tune, dyno proven 620whp.', category: 'JDM' },
  { id: 5, emoji: '🏎️', imgBg: 'linear-gradient(160deg,#1a0510,#2e0a20)', name: 'Lamborghini Huracán EVO', spec: '2020 · 8,000 km · Viola Pasifae', price: '₹3.5 Cr', location: 'Bangalore', views: '3.4K', verified: true, hp: '640', kmph: '325', sprint: '2.9s', engine: '5.2L V10 NA', features: ['LDVI System', 'MagneRide', 'Lifting System', 'Sensonum Audio'], seller: { id: 'seller-5', name: 'KaranB', sub: 'Verified Seller · 6 listings', bg: 'linear-gradient(135deg,#f0c040,#ff4d2e)', color: '#000' }, desc: 'One of only 3 in this rare purple in India.', category: 'Supercar' },
  { id: 6, emoji: '🚗', imgBg: 'linear-gradient(160deg,#0a1200,#142400)', name: 'Porsche 911 GT3 RS', spec: '2023 · 2,000 km · Guards Red', price: '₹2.9 Cr', location: 'Chennai', views: '1.8K', verified: true, hp: '525', kmph: '296', sprint: '3.2s', engine: '4.0L Flat-6 NA', features: ['Weissach Package', 'PDK', 'Carbon Roof', 'Sport Exhaust'], seller: { id: 'seller-6', name: 'VijayS', sub: 'Verified Seller · 3 listings', bg: 'linear-gradient(135deg,#ff4d2e,#c0392b)', color: '#fff' }, desc: 'Virtually new GT3 RS, barely driven. Full Porsche warranty remaining.', category: 'Sports' },
]
